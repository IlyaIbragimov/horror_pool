...
public class GenreController {
    ...
    @Operation(summary = "Add a new genre", description = "Create a new genre. Only accessible to administrators.")
    ...
    @Operation(summary = "Edit a genre", description = "Update an existing genre by genre ID. Only accessible to administrators.")
    ...
    @Operation(summary = "Search genres by keyword", description = "Search genres by keyword with pagination support. Available for all users.")
